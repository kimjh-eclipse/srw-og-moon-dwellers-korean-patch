...
v20260919는 PSARC 5개와 제목·아이콘 2개를 대상으로 **바뀐 바이트 구간만** ISO에 덮어씁니다.
...
- ISO 정리 옵션은 설치 데이터와 루트 SPU 캐시 파일을 정리합니다. 하위 SPU 캐시는 수동 정리가 필요합니다. 세이브·PPU·셰이더 캐시는 정리하지 않습니다.
- 폴더 직접 패치에는 ISO용 정리 옵션이 적용되지 않습니다. hdd0를 직접 패치했다면 그 폴더를 삭제하지 마세요.
- 사용자 절차는 [최신 설치 안내](../../docs/install.md)를 따르세요.
