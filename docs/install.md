...
[OGMD_KR_v20260907.zip](https://github.com/kimjh-eclipse/srw-og-moon-dwellers-korean-patch/releases/download/v20260907/OGMD_KR_v20260907.zip)
을 받아 압축을 풉니다. 최신판은
[Releases](https://github.com/kimjh-eclipse/srw-og-moon-dwellers-korean-patch/releases/latest)
에서 확인하세요.

```
OGMD_KR_v20260907.zip   104,626,875 바이트
SHA-256: F404229D54D4975853E30D0440602C4CCE81ED6E205052D08AC759CA1C9734DC
```

```powershell
Get-FileHash .\OGMD_KR_v20260907.zip -Algorithm SHA256
```
...
ZIP 안에 `OGMD_KR_v20260907` 폴더가 들어 있습니다. 압축을 풀면
